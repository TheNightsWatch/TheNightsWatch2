...
// I use minotar because it allows CORS requests.
    img.src = 'https://minecraftskins.herokuapp.com/skin/' + username;
    ...
    function Animate() {
        ...
        alpha += Math.PI / 320;
        camera.position.z = radius * Math.cos(rotate);
        camera.position.x = radius * Math.sin(rotate);
